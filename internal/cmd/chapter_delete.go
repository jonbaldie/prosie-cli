...
func (c *RootCmd) executeChapterDelete(args []string) int {
	...
	if !*yesFlag {
		fmt.Fprintf(c.Out, "Are you sure you want to delete chapter %s? [y/N]: ", id)
	...
	if err := cli.DeleteChapter(context.Background(), id); err != nil {
...
func (c *RootCmd) PrintChapterDeleteHelp() {
