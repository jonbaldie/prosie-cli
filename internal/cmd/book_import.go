...
func (c *RootCmd) executeBookImport(args []string) int {
	...
	book, err := cli.ImportDocx(context.Background(), filePath, *title)
	if err != nil {
...
func (c *RootCmd) PrintBookImportHelp() {
